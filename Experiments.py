...
def caseload_experiment(file_name="caseload.csv"):
    game = Game()
    game.init_payoffs()
...
def muddy_caseload_experiment(file_name="muddy_caseload.csv"):
...
def alspac_caseload_experiment(file_name="alspac_caseload.csv"):
    game = Game()
    game.init_payoffs()
