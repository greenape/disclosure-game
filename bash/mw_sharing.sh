...
python -m scoop -v HPCExperiments.py -R 25 ${GAME[$PBS_ARRAYID]}  --pickled-arguments mw_sharing.args -f ${PBS_ARRAYID}_mw_sharing --individual-measures -i 1000 -d /scratch/jg1g12