...
python Run.py -R 25 ${GAME[$PBS_ARRAYID]} --pickled-arguments mw_sharing.args -f ${PBS_ARRAYID}_mw_sharing -i 1000 -d /scratch/jg1g12 -g CarryingInformationGame CaseloadSharingGame 