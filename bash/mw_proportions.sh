...
python -m scoop -v HPCExperiments.py -R 10 ${GAME[$PBS_ARRAYID]}  --pickled-arguments mw_proportions.args -f ${PBS_ARRAYID}_mw_proportions --individual-measures -i 1000 -d /scratch/jg1g12