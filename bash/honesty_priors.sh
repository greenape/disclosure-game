...
module load python
ulimit -n 512
python -m scoop HPCExperiments.py -R 10 ${GAME[$PBS_ARRAYID]} --pickled-arguments honesty_priors.args -f ${PBS_ARRAYID}_honesty_priors_ --individual-measures -i 1000