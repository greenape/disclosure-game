...
qsub -t 0-204 -vpython=/home/jg1g12/pypy/bin/pypy,sig=SharingProspectPayoffSignaller,game=CarryingInformationGame,resp=SharingProspectPayoffResponder mw_sharing_new.sh
...
qsub -t 0-204 -vpython=/home/jg1g12/pypy/bin/pypy,sig=SharingProspectPayoffSignaller,game=CarryingInformationGame,resp=SharingProspectPayoffResponder w_sharing_new.sh
