...
python -m scoop -v HPCExperiments.py -R 35 ${GAME[$PBS_ARRAYID]}  --pickled-arguments women_proportions.args -f ${PBS_ARRAYID}_women_proportions --individual-measures -i 1000 -d /scratch/jg1g12